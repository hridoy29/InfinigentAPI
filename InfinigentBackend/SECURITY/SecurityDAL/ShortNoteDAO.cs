...
{
    public class ShortNoteDAO
    {
        private static volatile ShortNoteDAO instance;
        ...
        public static ShortNoteDAO GetInstanceThreadSafe
        {
            get
            {
                if (instance == null)
                    lock (lockObj)
                    {
                        if (instance == null) instance = new ShortNoteDAO();
                    }
        ...
        public static ShortNoteDAO GetInstance()
        {
            if (instance == null) instance = new ShortNoteDAO();
            return instance;
        }
        ...
        public async Task<List<LU_ShortNote>> GetShortNotes()
        {
            try
            {
                ...
                var ad_ItemLst = new List<LU_ShortNote>();
             
                ad_ItemLst =  dbExecutor.FetchData<LU_ShortNote>(CommandType.StoredProcedure, "get_shortnotes");
