...
namespace SecurityDAL
{
    ...
    {
        private static volatile IssuesDAO instance;
        ...
        public static IssuesDAO GetInstanceThreadSafe
        {
            get
            {
                if (instance == null)
                    lock (lockObj)
                    {
                        if (instance == null) instance = new IssuesDAO();
                    }
        ...
        public async Task<List<LU_Issues>> GetIssues()
        {
            try
            {
                ...
                var ad_ItemLst = new List<LU_Issues>();
             
                ad_ItemLst = dbExecutor.FetchData<LU_Issues>(CommandType.StoredProcedure, "get_issues");
